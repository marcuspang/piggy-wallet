...
const SavingsContainer: FunctionComponent<SavingsContainerType> = ({
  ...
  return (
    <div
      className={`flex-1 flex flex-col items-start justify-start gap-[12px] shrink-0 max-w-full text-left text-lg text-neutral-700 font-paragraph-small-bold ${className}`}
    >
