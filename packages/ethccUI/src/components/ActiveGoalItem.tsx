...
export type ActiveGoalItemType = {
  className?: string;
  prop?: string;
  campingTrip?: string;
  avatar?: string;
...
const ActiveGoalItem: FunctionComponent<ActiveGoalItemType> = ({
  className = "",
  prop,
  campingTrip,
  avatar,
  ...
  const activeGoalItem1Style: CSSProperties = useMemo(() => {
    return {
