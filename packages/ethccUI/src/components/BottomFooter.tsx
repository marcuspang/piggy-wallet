...
const BottomFooter: FunctionComponent<BottomFooterType> = ({
  ...
  return (
    <section
      className={`absolute bottom-[0px] left-[0px] bg-gray-100 w-full h-[86px] flex flex-col items-end justify-start pt-[79px] px-4 pb-[3px] box-border gap-[9px] z-[1] text-center text-xs text-brand-green-500 font-text-xs-light ${className}`}
    >
      ...
      <div className="mt-[-86px] self-stretch h-[77px] relative shrink-0 text-sm text-text-brand-default font-paragraph-small-bold">
        <div className="absolute top-[21px] left-[0px] w-full flex flex-row items-center justify-between gap-[20px]">
          <div className="flex flex-row flex-wrap items-start justify-start">
            ...
            <div className="flex flex-col items-center justify-start py-spacing-xx-sm px-5 gap-[4px] text-text-default-secondary">
              <img
                className="w-6 h-6 relative overflow-hidden shrink-0"
                loading="lazy"
                alt=""
          ...
          <div className="flex flex-row flex-wrap items-start justify-start text-text-default-secondary">
            <div className="flex flex-col items-center justify-start py-spacing-xx-sm px-[19px] gap-[4px]">
              <img
                className="w-6 h-6 relative overflow-hidden shrink-0"
                loading="lazy"
            ...
            <div className="flex flex-col items-center justify-start py-spacing-xx-sm px-[22px] gap-[4px]">
              <img
                className="w-6 h-6 relative overflow-hidden shrink-0"
                loading="lazy"
                alt=""
