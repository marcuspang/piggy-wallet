  ...
  return (
    ...
    >
      <div className="flex-1 rounded-spacing-md bg-whitesmoke box-border flex flex-col items-start justify-start py-3.5 px-[15px] relative gap-[12px] max-w-full border-[1px] border-solid border-neutral-200">
        ...
        <SavingsProfiles avatar1="/avatar-11@2x.png" />
        ...
        <div className="w-full !m-[0] absolute top-[-93px] right-[0px] left-[0px] rounded-spacing-md bg-base-white box-border flex flex-row flex-wrap items-start justify-start py-[22px] px-[23px] gap-[24px] min-w-[240px] z-[3] text-5xl text-neutral-900 border-[1px] border-solid border-border-default-default">
          ...
          <div className="flex-1 flex flex-col items-start justify-start gap-[24px] min-w-[160px]">
            <div className="self-stretch flex flex-col items-start justify-start gap-[12px]">
              ...
              <div className="self-stretch rounded-radius-200 bg-base-white box-border overflow-hidden flex flex-row items-center justify-start py-2.5 px-[15px] gap-[8px] min-w-[240px] text-lg text-neutral-800 border-[1px] border-solid border-border-default-default">
                <div className="flex-1 relative leading-[28px] font-medium inline-block overflow-hidden text-ellipsis whitespace-nowrap min-w-[44px]">
                  $50.00
                </div>
            ...
            <button className="cursor-pointer py-2.5 px-5 bg-brand-500 self-stretch rounded-radius-200 overflow-hidden flex flex-row items-center justify-center gap-[8px] border-[1px] border-solid border-brand-600">
              <img
                ...
                src="/star7.svg"
              />
              <b className="relative text-base leading-[24px] inline-block font-paragraph-small-bold text-text-brand-on-brand text-left min-w-[121px]">{`Confirm & Send`}</b>
              <img
                className="h-4 w-4 relative overflow-hidden shrink-0 hidden"
                alt=""
                src="/x8.svg"
