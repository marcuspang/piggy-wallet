...
const ParentsSendFeature2: FunctionComponent = () => {
  return (
    <div className="w-full relative rounded-xl bg-base-white overflow-hidden flex flex-row items-start justify-start pt-[5px] pb-[579px] pr-4 pl-0 box-border leading-[normal] tracking-[normal] text-left text-base text-neutral-700 font-paragraph-small-bold">
      ...
      <section className="flex-1 bg-gray-100 box-border overflow-hidden flex flex-col items-end justify-start pt-3.5 px-0 pb-0 gap-[24px] max-w-[105%] shrink-0 text-left text-base text-text-default-default font-single-line-body-base border-b-[1px] border-solid border-neutral-100">
          ...
          <div className="self-stretch flex flex-col items-start justify-start py-0 px-spacing-md gap-[12px]">
            <div className="self-stretch rounded-spacing-md flex flex-col items-start justify-start">
              <div className="self-stretch flex flex-col items-start justify-start gap-[4px]">
                <b className="relative leading-[28px] inline-block min-w-[115px]">
                  Your Balance
                </b>
      ...
      <footer className="w-full !m-[0] absolute right-[0px] bottom-[0px] left-[0px] bg-gray-100 flex flex-col items-end justify-start pt-3.5 px-4 pb-[3px] box-border gap-[9px] z-[1] text-center text-sm text-brand-500 font-paragraph-small-bold">
      ...
      <AllowanceInput radio="/radio.svg" star="/star7.svg" x="/x8.svg" />
    </div>
  );
};

export default ParentsSendFeature2;
