    ...
    >
      <div className="self-stretch rounded-spacing-md bg-whitesmoke flex flex-col items-start justify-start py-3.5 px-[15px] gap-[12px] border-[1px] border-solid border-neutral-200">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[4px]">
          ...
          <div className="self-stretch flex flex-row items-center justify-start gap-[12px] text-25xl text-black-500 font-heading-mobile-h6-semi-bold">
            <div className="flex-1 relative tracking-[-0.02em] leading-[48px] font-semibold whitespace-nowrap">
              $1,800.10
            </div>
            <div className="h-9 w-9 rounded-scale-06 overflow-hidden shrink-0 hidden flex-row items-center justify-center p-2 box-border">
              <img
            ...
            <div className="w-[70px] rounded-radius-200 bg-base-white box-border overflow-hidden shrink-0 flex flex-row items-center justify-center py-1.5 px-[7px] gap-[8px] text-base text-neutral-900 font-paragraph-small-bold border-[1px] border-solid border-brand-500">
              <img
      ...
      <button className="cursor-pointer py-2.5 px-5 bg-brand-500 self-stretch rounded-radius-200 overflow-hidden flex flex-row items-center justify-center gap-[8px] border-[1px] border-solid border-brand-600">
        <img
          ...
          src="/star7.svg"
        />
        <b className="relative text-base leading-[24px] inline-block font-paragraph-small-bold text-text-brand-on-brand text-left min-w-[117px]">
          Receive Money
        </b>
        <img
          className="h-4 w-4 relative overflow-hidden shrink-0 hidden"
