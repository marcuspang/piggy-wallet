...
const FrameComponent: FunctionComponent<FrameComponentType> = ({
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start py-0 px-4 box-border max-w-full text-left text-9xl text-black-500 font-heading-mobile-h6-semi-bold mt-20 pt-40 ${className}`}
    >
