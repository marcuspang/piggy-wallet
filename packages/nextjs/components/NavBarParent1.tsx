...
const NavBarParent: FunctionComponent<NavBarParentType> = ({
  ...
  return (
    <footer
      className={`w-full !m-[0] absolute right-[0px] bottom-[0px] left-[0px] bg-gray-100 flex flex-col items-end justify-start pt-3.5 px-4 pb-[3px] box-border gap-[9px] z-[1] text-center text-sm text-text-default-secondary font-paragraph-small-bold ${className}`}
    >
