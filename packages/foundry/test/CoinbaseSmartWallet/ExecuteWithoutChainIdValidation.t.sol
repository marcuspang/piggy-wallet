...
contract TestExecuteWithoutChainIdValidation is SmartWalletTestBase {
    ...
    function setUp() public override {
        ...
        userOpCalldata = abi.encodeWithSelector(TimelockSmartWallet.executeWithoutChainIdValidation.selector);
    }
    ...
    function test_succeeds_whenSelectorAllowed() public {
        ...
        userOpCalldata = abi.encodeWithSelector(TimelockSmartWallet.executeWithoutChainIdValidation.selector, calls);
    ...
    function test_reverts_whenSelectorNotApproved() public {
        bytes4 selector = TimelockSmartWallet.execute.selector;
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                TimelockSmartWallet.SelectorNotAllowed.selector, TimelockSmartWallet.execute.selector
            )
        );
        account.executeWithoutChainIdValidation(calls);
    }
    ...
    function test_reverts_whenOneSelectorNotApproved() public {
        bytes4 badSelector = TimelockSmartWallet.execute.selector;
    ...
    function _sign(UserOperation memory userOp) internal view override returns (bytes memory signature) {
        ...
        signature = abi.encode(TimelockSmartWallet.SignatureWrapper(0, abi.encodePacked(r, s, v)));
    }
}
