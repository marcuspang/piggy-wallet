...
import {MockTimelockBountySmartWallet} from "../mocks/MockTimelockBountySmartWallet.sol";
import {Static} from "../TimelockSmartWallet/Static.sol";

contract TimelockBountySmartWalletTestBase is Test {
    TimelockBountySmartWallet public account;
    ...
    function setUp() public virtual {
        ...
        account.initialize(owners, 0, 0, address(0));
    }
