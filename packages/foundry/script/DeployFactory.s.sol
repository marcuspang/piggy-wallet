...
import {TimelockSmartWallet, TimelockSmartWalletFactory} from "../src/TimelockSmartWalletFactory.sol";
...
contract DeployFactoryScript is Script {
    ...
    function run() public {
        ...
        address implementation = SafeSingletonDeployer.broadcastDeploy({
            creationCode: type(TimelockSmartWallet).creationCode,
        ...
        address factory = SafeSingletonDeployer.broadcastDeploy({
            creationCode: type(TimelockSmartWalletFactory).creationCode,
